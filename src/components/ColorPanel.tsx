 ...
 * - white  => fg-default
 */
const toneClasses: Record<Tone, { border: string; railBg: string }> = {
  yellow: { border: "border-accent-yellow", railBg: "bg-accent-yellow" },
  blue: { border: "border-accent-blue", railBg: "bg-accent-blue" },
  pink: { border: "border-accent-pink", railBg: "bg-accent-pink" },
  white: { border: "border-fg-default", railBg: "bg-fg-default" },
};
    ...
    >
      ...
      <div
        className={cx(
          ...
          "whitespace-nowrap overflow-visible leading-none select-none self-stretch"
        )}
